//package com.springboot.decryption.service;
//
//import javax.crypto.*;
...
//
//    public String Decrypt() throws NoSuchAlgorithmException, InvalidKeySpecException, IOException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, InvalidKeyException {
//        String key;
...
//        fl.close();
//
//       // encoded = encrypt.getBytes();
//
//        KeySpec keySpec = new PBEKeySpec(key.toCharArray(), salt, 65536,80);
//        SecretKey secretKey= SecretKeyFactory.getInstance("PBKDF2WithHmacSHA1").generateSecret(keySpec);
//
//        Cipher dcipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
//        AlgorithmParameterSpec paramSpec = new PBEParameterSpec(salt, 65536);
